    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <ol class="breadcrumb my-4">
                            <li class="breadcrumb-item">Pengaturan Rak</li>
                            <li class="breadcrumb-item active">Kepemilikan</li>
                        </ol>
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card mb-4">
                ...
                <?php include './layout/modal_tambah_kepemilikan.php';?>
        ...
        <script src="js/pages/kepemilikan.js"></script>
    </body>
</html>
